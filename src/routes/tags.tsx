        ...
        {showOverview && (
          <div className="rounded-2xl border border-border bg-card p-5">
            <h3 className="text-[14px] font-bold text-foreground mb-0.5">
              Visão Geral — Distribuição de Tags
            </h3>
                  ...
                  <div className="mt-3">
                    <div className="h-1 rounded-full bg-muted overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${leads.length > 0 ? Math.min((count / leads.length) * 100, 100) : 0}%`,
                        }}
                      />
                    </div>
                      ...
                      <div className="space-y-2">
                        {tagLeads.map((lead) => (
                          <button
                            key={lead.id}
                            onClick={() =>
                              navigate({ to: "/atendimentos", search: { leadId: lead.id } })
                            }
                          ...
                          >
                            ...
                            <div className="flex-1 min-w-0 text-left">
                              <p className="text-[11px] font-medium text-foreground truncate hover:text-primary">
                                {lead.name}
                              </p>
