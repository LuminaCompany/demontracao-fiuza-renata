...
export const attendants: Attendant[] = [
  {
    ...
    name: "Claudia Santos",
    initials: "CS",
    email: "claudia@estruturalvidros.com.br",
  ...
  },
  {
    ...
    name: "Débora Lima",
    initials: "DL",
    email: "debora@estruturalvidros.com.br",
  ...
  },
  {
    ...
    name: "Joana Martins",
    initials: "JM",
    email: "joana@estruturalvidros.com.br",
  ...
  },
  {
    ...
    name: "Rafael Costa",
    initials: "RC",
    email: "rafael@estruturalvidros.com.br",
  ...
  },
  {
    ...
    name: "Marcos Souza",
    initials: "MS",
    email: "marcos@estruturalvidros.com.br",
...
export const accounts: Account[] = [
  {
    ...
    role: "gestor",
    initials: "CM",
    email: "carlos@estruturalvidros.com.br",
    color: "#3b82f6",
  },
  {
    id: "acc2",
...
export const leads: Lead[] = [
  // ── Lead 1: Novo lead — fluxo de IA selecionando atendente ──
  {
    ...
    messages: [
      ...
      },
      {
        id: "m4",
        content:
          "Perfeito! Conectando você com a **Claudia** agora... 🔄\nUm momento, por favor!",
        sender: "ai",
        senderName: "IA Estrutural",
        time: "09:47",
      },
      {
        id: "m5",
        content: "Atendimento transferido para Claudia (Vendas)",
        sender: "system",
        time: "09:47",
      },
    ],
  ...
  // ── Lead 2: Ativo — conversa em andamento ──
  {
    ...
    messages: [
      ...
      },
      {
        id: "m4",
        content:
          "Perfeito! Transferindo para a **Claudia** agora... 🔄",
        sender: "ai",
        senderName: "IA Estrutural",
        time: "10:16",
      },
      ...
      },
      {
        id: "m6",
        content:
          "Oi Ana Paula! Aqui é a Claudia 😊 Que ótimo que entrou em contato! Para fazer o orçamento do box, você pode me passar as medidas do seu banheiro?",
        sender: "attendant",
        senderName: "Claudia",
        time: "10:18",
        status: "read",
  ...
  // ── Lead 3: Ativo — Débora, janelas ──
  {
    ...
    messages: [
      ...
      {
        id: "m4",
        content: "Perfeito! Transferindo para a **Débora** agora... 🔄",
        sender: "ai",
        senderName: "IA Estrutural",
        time: "08:31",
      },
      {
        id: "m5",
        content: "Atendimento transferido para Débora (Vendas)",
        sender: "system",
        time: "08:31",
      },
      {
        id: "m6",
        content:
          "Olá Maria! Sou a Débora 😊 Que tipo de janela você está pensando? Correr, guilhotina ou de abrir?",
        sender: "attendant",
        senderName: "Débora",
        time: "08:45",
        status: "read",
  ...
  // ── Lead 4: Pendente — sem resposta ──
  {
    ...
    messages: [
      ...
      },
      {
        id: "m4",
        content:
          "Perfeito! Transferindo para **Rafael** (Vendas) agora... 🔄",
        sender: "ai",
        senderName: "IA Estrutural",
        time: "07:16",
      },
      {
        id: "m5",
        content: "Atendimento transferido para Rafael (Vendas)",
        sender: "system",
        time: "07:16",
      },
      {
  ...
  // ── Lead 5: Ativo — Joana, suporte/garantia ──
  {
    id: "l5",
    ...
    messages: [
      ...
      {
        id: "m4",
        content: "Perfeito! Transferindo para a **Joana** (Suporte) agora... 🔄",
        sender: "ai",
        senderName: "IA Estrutural",
        time: "13:41",
      },
      {
        id: "m5",
        content: "Atendimento transferido para Joana (Suporte)",
        sender: "system",
        time: "13:41",
      },
      {
        id: "m6",
        content:
          "Oi Fernanda! Aqui é a Joana 😊 Entendo, isso está dentro da garantia sim! Você pode me mandar uma foto do problema para eu acionar nossa equipe técnica?",
        sender: "attendant",
        senderName: "Joana",
        time: "13:43",
        status: "read",
  ...
  // ── Lead 6: Finalizado com resumo de IA ──
  {
    ...
    messages: [
      ...
      },
      {
        id: "m6",
        content:
          "Roberto! Aqui é a Claudia. Que ótimo! Me passa as medidas que faço o orçamento 🙂",
        sender: "attendant",
        senderName: "Claudia",
        time: "14:05",
        status: "read",
  ...
  // ── Lead 8: Ativo — Rafael ──
  {
    ...
    messages: [
      ...
      },
      {
        id: "m6",
        content:
          "Lucas! Aqui é o Rafael. Você quer agendar a instalação do vidro da mesa, certo?",
        sender: "attendant",
        senderName: "Rafael",
        time: "15:45",
        status: "read",
      ...
      },
      {
        id: "m8",
        content:
          "Pode ser sexta-feira às 14h. Nosso técnico Marcos estará aí. Confirma?",
        sender: "attendant",
        senderName: "Rafael",
        time: "16:05",
        status: "read",
  ...
  // ── Lead 9: Ativo — Claudia, cliente recorrente ──
  {
    id: "l9",
    ...
    messages: [
      {
        id: "m6",
        content:
          "Oi Sandra, cliente VIP! Como posso ajudar hoje? 😊",
        sender: "attendant",
        senderName: "Claudia",
        time: "09:20",
        status: "read",
      ...
      {
        id: "m7",
        content: "Claudia! Quero mais um box igual ao que comprei no ano passado para o outro banheiro",
        sender: "client",
        time: "09:25",
        status: "read",
      },
  ...
  // ── Lead 10: Finalizado com resumo de IA ──
  {
    ...
    aiSummary:
      "**Resumo do Atendimento — gerado por IA**\n\nCliente Marcos Henrique entrou em contato para substituição das janelas da sala. Atendido pela Débora.\n\n**Produto adquirido:**\n• Janela de Correr 3 Folhas Alumínio (2,00x1,20m) — R$ 3.600\n**Forma de pagamento:** Cartão de crédito 6x\n\n**Histórico:** Cliente pesquisou preços antes, escolheu a Estrutural pelo prazo e qualidade. Instalação realizada em 8 dias úteis pelo técnico Marcos Souza. Zero problemas relatados.\n\n**Satisfação:** Cliente deu nota 5 estrelas e sinalizou possível interesse em trocar portas no segundo semestre.",
    messages: [
      {
        id: "m5",
        content: "Atendimento transferido para Débora (Vendas)",
  ...
  // ── Lead 11: Pendente ──
  {
    ...
    messages: [
      ...
      {
        id: "m4",
        content: "Perfeito! Transferindo para a **Claudia** agora... 🔄",
        sender: "ai",
        senderName: "IA Estrutural",
        time: "17:32",
      },
